...
type SendBestallningGodkandParams = {
  to: string
  buyerName: string
  serviceTitle: string
  sellerName: string
...
export async function sendBestallningGodkand({
  to,
  buyerName,
  serviceTitle,
  sellerName,
...
<html lang="sv">
          ...
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:32px 24px;">
                <h1 style="margin:0 0 16px;font-size:22px;line-height:1.3;color:#1a1a1a;">Din beställning är godkänd! ✅</h1>
                <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#444444;">Hej ${escapeHtml(buyerName)}! ${escapeHtml(sellerName)} har godkänt din beställning och jobbet är igång.</p>
  ...
  return sendEmail({
    to,
    subject: 'Din beställning är godkänd! ✅',
    html,
  })
}
