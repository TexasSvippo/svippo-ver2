...
import { fetchConversations as fetchConversationsShared, formatConversationTime, type Conversation } from '@/lib/conversations'
...
function MessagesContent() {
  ...
  const fetchConversations = async () => {
    if (!user) return
    const enriched = await fetchConversationsShared(user.id)
              ...
              >
                ...
                <div className={styles.conv_info}>
                  <div className={styles.conv_top}>
                    ...
                    <span className={styles.conv_time}>{formatConversationTime(conv.last_message_at)}</span>
                  </div>
                  {conv.orderTitle && (
