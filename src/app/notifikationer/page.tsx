...
const getActionBtn = (notif: Notification, onRead: (id: string) => void) => {
  const actions: Record<string, { href: string; label: string; className: string }> = {
    project_completed: { href: `/min-bestallning/${notif.order_id}`, label: 'Lämna recension', className: 'btn btn-primary' },
    request_review: { href: `/bestallning/${notif.order_id}`, label: 'Ta betalt', className: 'btn btn-orange' },
    new_order: { href: `/bestallning/${notif.order_id}`, label: 'Se beställning', className: 'btn btn-primary' },
    order_accepted: { href: `/min-bestallning/${notif.order_id}`, label: 'Se beställning', className: 'btn btn-primary' },
    order_rejected: { href: `/min-bestallning/${notif.order_id}`, label: 'Se beställning', className: 'btn btn-outline' },
    new_interest: { href: `/intresseanmalningar`, label: 'Se intresse', className: 'btn btn-orange' },
    new_review: { href: notif.action_url || '/profil', label: 'Se recension', className: 'btn btn-primary' },
    new_request_in_category: { href: notif.action_url || '/forfragningar', label: 'Se förfrågan', className: 'btn btn-primary' },
  }
